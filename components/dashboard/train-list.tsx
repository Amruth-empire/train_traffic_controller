...
import { Train, Clock, MapPin, Users, Gauge, Settings, AlertTriangle } from "lucide-react"
                  ...
                  <div className="flex items-center space-x-2 text-slate-300">
                    ...
                    <span>
                      {train.estimatedArrival
                        ? train.estimatedArrival.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })
                        : train.scheduledArrival.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}
                    </span>
                  </div>
                  {train.type !== "freight" && (
                    <div className="flex items-center space-x-2 text-slate-300">
                ...
                <div className="mt-4 pt-3 border-t border-slate-600">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-4">
                      ...
                      <span className={`font-semibold ${getPriorityColor(train.priority)}`}>{train.priority}/10</span>
                    </div>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="flex justify-end mt-3 space-x-2">
                    ...
                    <PermissionGuard permission="control_trains">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => handleTrainControl(train.id, "update_priority")}
